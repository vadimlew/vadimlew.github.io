...
app.resize = function(e) {
	...
	if (app.mainWidth < app.mainHeight) {		
		...
		app.obj2d.timeBar.x = 0;
		app.obj2d.timeBar.y = upUI + 120;

		app.obj2d.fakeJoystick.position.set(0, downUI - 300);

		app.obj2d.killAllText.position.set( 0, upUI + 122 );

		if (app.stateGame === 'loaded' || app.stateGame === 'colorChoised') {
			app.obj2d.joystick.position.set(0, downUI - 300);
		}
		...
		/*app.obj2d.downloadBtn.x = rightUI - 190;
		app.obj2d.downloadBtn.y = downUI - 100;
		...
		app.obj2d.timeBar.x = 0;
		app.obj2d.timeBar.y = upUI + 80;

		app.obj2d.fakeJoystick.position.set(rightUI - 170, downUI - 170);

		app.obj2d.killAllText.position.set( 0, downUI - 90 );

		if (app.stateGame === 'loaded' || app.stateGame === 'colorChoised') {
			app.obj2d.joystick.position.set(rightUI - 170, downUI - 170);
		}
	...
	app.obj2d.choiceScreen.onResize();
}