class Template {
    downloadButton ({text = 'DOWNLOAD', bgColor = 0xfff000, textColor = 0x4e2f16} = {}) {
    ...
    overlay (stageDownHandler, stageMoveHandler, stageUpHandler) {
    ...
    text ({txt='', color=0xffffff, fontSize=50, fontFamily='font_baloo'}) {
    ...
    outlinedText ({txt='', color=0xffffff, fontSize=50, fontFamily='font_baloo', outlineColor=0x000000, outlineWidth=4}) {
    ...
    joystick ({player, layer, maxSpeed=1, isTutor=false}) {
        let hand;
        let bgSize = 100;
        let barSize = 35;
