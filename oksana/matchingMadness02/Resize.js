...
app.resize = function(e) {
	...
	if (isPortraite) {
		...
		app.obj2d.endScreen.portrait( upUI, rightUI, leftUI, downUI );				
		app.obj2d.firstScreen.portrait( upUI, rightUI, leftUI, downUI );		
		app.obj2d.gameScene.portrait( upUI, rightUI, leftUI, downUI );		
		app.obj2d.failEnd.portrait( upUI, rightUI, leftUI, downUI );	

	    //app.obj2d.finish.portrait(upUI,downUI);
		...
		app.obj2d.endScreen.landscape( upUI, rightUI, leftUI, downUI );			
		app.obj2d.firstScreen.landscape( upUI, rightUI, leftUI, downUI);		
		app.obj2d.gameScene.landscape(upUI, rightUI, leftUI, downUI);
		app.obj2d.failEnd.landscape( upUI, rightUI, leftUI, downUI );	
		
		//app.obj2d.finish.landscape(rightUI, downUI);
